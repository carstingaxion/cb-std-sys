...
?>
	...
	<div class="social-post">
		...
		<?php
				...
				echo '<div class="allowed-comment-tags">'.__('Allowed tags', 'cb-std-sys').': '.allowed_tags().'</div>';
			}
			else {
...
?>
	<div id="social-tabs-comments">
		...
		<ul class="social-nav social-clearfix">
			...
			<li class="social-all social-tab-main social-current-tab"><a href="#" rel="social-all"><span><?php comments_number(__('0 Replies', 'social'), __('1 Reply', 'social'), __('% Replies', 'social')); ?></span></a></li>

			<?php if ( isset($groups['wordpress']) && ( isset($groups['twitter'])  || isset($groups['facebook']) || isset($groups['pingback']) ) ) { ?>
			<li class="social-wordpress"><a href="#" rel="social-wordpress"><span><?php printf(_n('1 Comment', '%1$s Comments', (isset($groups['wordpress']) ? $groups['wordpress'] : 0), 'social'), (isset($groups['wordpress']) ? $groups['wordpress'] : 0)); ?></span></a></li>

			<?php } if ( isset($groups['twitter'] ) ) { ?>
			<li class="social-twitter"><a href="#" rel="social-twitter"><span><?php printf(_n('1 Tweet', '%1$s Tweets', (isset($groups['twitter']) ? $groups['twitter'] : 0), 'social'), (isset($groups['twitter']) ? $groups['twitter'] : 0)); ?></span></a></li>

			<?php } if ( isset($groups['facebook'] ) ) { ?>
			<li class="social-facebook"><a href="#" rel="social-facebook"><span><?php printf(_n('1 Facebook', '%1$s Facebook', (isset($groups['facebook']) ? $groups['facebook'] : 0), 'social'), (isset($groups['facebook']) ? $groups['facebook'] : 0)); ?></span></a></li>

      <?php } if ( isset($groups['pingback'] ) ) { ?>
			<li class="social-pingback"><a href="#" rel="social-pingback"><span><?php printf(_n('1 Pingback', '%1$s Pingbacks', (isset($groups['pingback']) ? $groups['pingback'] : 0), 'social'), (isset($groups['pingback']) ? $groups['pingback'] : 0)); ?></span></a></li>
      <?php } ?>
		</ul>
