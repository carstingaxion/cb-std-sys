...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<p><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr( printf( __( 'Return to %s', 'cb-std-sys' ), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
					/* translators: %s - title of parent post */
					printf( __( '<span>&larr;</span> %s', 'cb-std-sys' ), get_the_title( $post->post_parent ) );
				?></a></p>
